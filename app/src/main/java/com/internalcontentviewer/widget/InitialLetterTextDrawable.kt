package com.internalcontentviewer.widget
...
class InitialLetterTextDrawable private constructor(builder: Builder) : ShapeDrawable(builder.shape) {
...
//        }
        ...
        override fun buildRect(text: String?, color: Int): InitialLetterTextDrawable? {
            rect()
        ...
        override fun buildRoundRect(
            ...
            color: Int,
            radius: Int
        ): InitialLetterTextDrawable? {
            roundRect(radius)
            return build(text, color)
        }

        override fun buildRound(text: String?, color: Int): InitialLetterTextDrawable? {
            round()
            return build(text, color)
        }

        override fun build(text: String?, color: Int): InitialLetterTextDrawable? {
            this.color = color
            this.text = text?:""
            return InitialLetterTextDrawable(this)
        }
    }
...
//        fun useFont(font: Typeface): IConfigBuilder
    ...
    interface IBuilder {
        fun build(text: String?, color: Int): InitialLetterTextDrawable?
    }
    ...
    interface IShapeBuilder {
        ...
        fun buildRect(text: String?, color: Int): InitialLetterTextDrawable?
        fun buildRoundRect(text: String?, color: Int, radius: Int): InitialLetterTextDrawable?
        fun buildRound(text: String?, color: Int): InitialLetterTextDrawable?
    }
